...
func (h *DeploymentHandler) List(w http.ResponseWriter, r *http.Request, taskID string) {
...
func (h *DeploymentHandler) Active(w http.ResponseWriter, r *http.Request, taskID string) {
...
func (h *DeploymentHandler) Stop(w http.ResponseWriter, r *http.Request, deploymentID string) {
	if err := h.uc.StopDeployment(deploymentID); err != nil {
		handleErr(w, err)
		return
	}
...
func (h *DeploymentHandler) Export(w http.ResponseWriter, r *http.Request, taskID string) {
