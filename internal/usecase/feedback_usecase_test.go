...
func newFeedbackUsecase(
	...
	return usecase.NewFeedbackUsecase(taskRepo, fbRepo, exRepo, &fbStubIDGen{})
}
...
func TestFeedbackUsecase_SubmitMisprediction(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		taskRepo := &mockTaskRepo{task: &domain.Task{ID: "task-1", Name: "", Description: "", Type: "", CreatedAt: time.Time{}, UpdatedAt: time.Time{}}}
		fbRepo := &mockFeedbackRepo{}
		uc := newFeedbackUsecase(taskRepo, fbRepo, nil)
	...
	t.Run("task_not_found", func(t *testing.T) {
		...
		uc := newFeedbackUsecase(taskRepo, &mockFeedbackRepo{}, nil)
...
func TestFeedbackUsecase_ListFeedback(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		uc := newFeedbackUsecase(&mockTaskRepo{}, fbRepo, nil)
...
//nolint:gocognit // large test with many assertions
func TestFeedbackUsecase_FoldIntoDataset(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		exRepo := &mockExampleRepo{}
		uc := newFeedbackUsecase(&mockTaskRepo{}, fbRepo, exRepo)
	...
	t.Run("list_unresolved_error", func(t *testing.T) {
		...
		fbRepo := &mockFeedbackRepo{err: errRepoFailure}
		uc := newFeedbackUsecase(&mockTaskRepo{}, fbRepo, &mockExampleRepo{})
