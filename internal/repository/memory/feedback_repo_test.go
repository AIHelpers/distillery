...
func TestFeedbackRepo_Add(t *testing.T) {
	...
	r, s := newFeedbackRepo()
	f := &domain.Misprediction{ID: "fb_1", TaskID: "task_1", Input: "x", ExpectedOutput: "y", ActualOutput: "", Resolved: false, CreatedAt: time.Time{}}
...
func TestFeedbackRepo_Add_Multiple(t *testing.T) {
	...
	r, s := newFeedbackRepo()
	_ = r.Add(&domain.Misprediction{ID: "fb_1", TaskID: "task_1", Input: "", ActualOutput: "", ExpectedOutput: "", Resolved: false, CreatedAt: time.Time{}})
	_ = r.Add(&domain.Misprediction{ID: "fb_2", TaskID: "task_1", Input: "", ActualOutput: "", ExpectedOutput: "", Resolved: false, CreatedAt: time.Time{}})
...
func TestFeedbackRepo_Add_AcrossTasks(t *testing.T) {
	...
	r, s := newFeedbackRepo()
	_ = r.Add(&domain.Misprediction{ID: "fb_1", TaskID: "task_1", Input: "", ActualOutput: "", ExpectedOutput: "", Resolved: false, CreatedAt: time.Time{}})
	_ = r.Add(&domain.Misprediction{ID: "fb_2", TaskID: "task_2", Input: "", ActualOutput: "", ExpectedOutput: "", Resolved: false, CreatedAt: time.Time{}})
...
func TestFeedbackRepo_ListUnresolved(t *testing.T) {
	...
	r, _ := newFeedbackRepo()
	_ = r.Add(&domain.Misprediction{ID: "fb_1", TaskID: "task_1", Resolved: false, Input: "", ActualOutput: "", ExpectedOutput: "", CreatedAt: time.Time{}})
	_ = r.Add(&domain.Misprediction{ID: "fb_2", TaskID: "task_1", Resolved: true, Input: "", ActualOutput: "", ExpectedOutput: "", CreatedAt: time.Time{}})
	_ = r.Add(&domain.Misprediction{ID: "fb_3", TaskID: "task_1", Resolved: false, Input: "", ActualOutput: "", ExpectedOutput: "", CreatedAt: time.Time{}})
...
func TestFeedbackRepo_ListUnresolved_AllResolved(t *testing.T) {
	...
	r, _ := newFeedbackRepo()
	_ = r.Add(&domain.Misprediction{ID: "fb_1", TaskID: "task_1", Resolved: true, Input: "", ActualOutput: "", ExpectedOutput: "", CreatedAt: time.Time{}})
...
func TestFeedbackRepo_MarkResolved(t *testing.T) {
	...
	r, _ := newFeedbackRepo()
	_ = r.Add(&domain.Misprediction{ID: "fb_1", TaskID: "task_1", Resolved: false, Input: "", ActualOutput: "", ExpectedOutput: "", CreatedAt: time.Time{}})
	_ = r.Add(&domain.Misprediction{ID: "fb_2", TaskID: "task_1", Resolved: false, Input: "", ActualOutput: "", ExpectedOutput: "", CreatedAt: time.Time{}})
	_ = r.Add(&domain.Misprediction{ID: "fb_3", TaskID: "task_1", Resolved: false, Input: "", ActualOutput: "", ExpectedOutput: "", CreatedAt: time.Time{}})

	err := r.MarkResolved([]string{"fb_1", "fb_3"})
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
...
func TestFeedbackRepo_MarkResolved_AcrossTasks(t *testing.T) {
	...
	r, _ := newFeedbackRepo()
	_ = r.Add(&domain.Misprediction{ID: "fb_1", TaskID: "task_1", Resolved: false, Input: "", ActualOutput: "", ExpectedOutput: "", CreatedAt: time.Time{}})
	_ = r.Add(&domain.Misprediction{ID: "fb_2", TaskID: "task_2", Resolved: false, Input: "", ActualOutput: "", ExpectedOutput: "", CreatedAt: time.Time{}})

	err := r.MarkResolved([]string{"fb_1", "fb_2"})
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
...
func TestFeedbackRepo_MarkResolved_NonexistentID(t *testing.T) {
	...
	err := r.MarkResolved([]string{"nonexistent"})
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
