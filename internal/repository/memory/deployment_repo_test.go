...
func TestDeploymentRepo_Create(t *testing.T) {
	...
	dep := &domain.Deployment{ID: "dep_1", TaskID: "task_1", Status: domain.DeploymentActive}

	if err := r.Create(dep); err != nil {
...
func TestDeploymentRepo_Get_Found(t *testing.T) {
	...
	_ = r.Create(&domain.Deployment{ID: "dep_1", TaskID: "task_1"})
...
func TestDeploymentRepo_Get_AcrossTasks(t *testing.T) {
	r, _ := newDeploymentRepo()
	_ = r.Create(&domain.Deployment{ID: "dep_1", TaskID: "task_1"})
	_ = r.Create(&domain.Deployment{ID: "dep_2", TaskID: "task_2"})
...
func TestDeploymentRepo_GetActiveForTask_Found(t *testing.T) {
	r, _ := newDeploymentRepo()
	_ = r.Create(&domain.Deployment{ID: "dep_1", TaskID: "task_1", Status: domain.DeploymentStopped})
	_ = r.Create(&domain.Deployment{ID: "dep_2", TaskID: "task_1", Status: domain.DeploymentActive})
...
func TestDeploymentRepo_GetActiveForTask_LatestActive(t *testing.T) {
	r, _ := newDeploymentRepo()
	_ = r.Create(&domain.Deployment{ID: "dep_1", TaskID: "task_1", Status: domain.DeploymentActive})
	_ = r.Create(&domain.Deployment{ID: "dep_2", TaskID: "task_1", Status: domain.DeploymentStopped})
	_ = r.Create(&domain.Deployment{ID: "dep_3", TaskID: "task_1", Status: domain.DeploymentActive})
...
func TestDeploymentRepo_ListByTask(t *testing.T) {
	r, _ := newDeploymentRepo()
	_ = r.Create(&domain.Deployment{ID: "dep_1", TaskID: "task_1"})
	_ = r.Create(&domain.Deployment{ID: "dep_2", TaskID: "task_1"})
...
func TestDeploymentRepo_Update_Found(t *testing.T) {
	...
	updated := &domain.Deployment{ID: "dep_1", TaskID: "task_1", Status: domain.DeploymentStopped}
...
func TestDeploymentRepo_Update_NotFound(t *testing.T) {
	...
	err := r.Update(&domain.Deployment{ID: "missing", TaskID: "task_1"})
	if err != domain.ErrNotFound {
		t.Errorf("expected ErrNotFound, got %v", err)
	}
}
